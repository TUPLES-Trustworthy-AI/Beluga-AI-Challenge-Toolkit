class JigType:
    ...
    def copy(self):
        return JigType(self.name, self.size_empty, self.size_loaded)
...
class Jig:
    ...
    def __init__(self, name: str, type: JigType, empty: bool=False) -> None:
        self.name = name
        self.type = type
        self.empty = empty

    def copy(self):
        return Jig(self.name, self.type.copy(), self.empty)
