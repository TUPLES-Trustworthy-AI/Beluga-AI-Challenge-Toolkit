...
# ============================================================================
# Basic action and plan description
# ============================================================================
...
class BelugaAction(ABC):
    ...
    @staticmethod
    def from_json_obj(json_obj: dict[str,str], prb : BelugaProblem) -> BelugaAction:
        pass
...
class LoadBeluga(BelugaAction):
    ...
    @staticmethod
    def from_json_obj(json_obj: dict[str,str], prb : BelugaProblem):
...
def action_from_json_obj(json_obj : dict[str, str], prb : BelugaProblem) -> BelugaAction | None:
...
class BelugaPlan:
    ...
    def __init__(self, actions: list[BelugaAction] | None = None):
        if actions is None:
            self.actions: list[BelugaAction]= []
        else:
            self.actions: list[BelugaAction] = actions

    def append(self, action : BelugaAction):
        self.actions.append(action)

    def to_json_obj(self):
        return [a.to_json_obj() for a in self.actions]
    ...
    @staticmethod
    def from_json_obj(json_obj: list[dict[str, str]], prb: BelugaProblem):
